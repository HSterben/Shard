    ...
    <section id="features" className="bg-canvas py-16 text-ink md:py-20">
      <div className="page">
        ...
        <div className="grid gap-3 lg:grid-cols-5">
          <Reveal className="card-dark relative lg:col-span-3 p-7 pb-14 md:p-10 md:pb-16">
            ...
            <h3 className="mt-5 text-xl font-semibold md:text-[22px]">Streaming replies</h3>
            ...
            <div className="overflow-hidden rounded-[12px] border border-white/10 bg-graphite shadow-[0_24px_60px_rgba(0,0,0,0.45)]">
                <img
              ...
              <img
                ...
                className="absolute -bottom-8 right-0 w-[52%] max-w-[17rem] rounded-[1.25rem] border border-white/10 object-cover drop-shadow-[0_18px_40px_rgba(0,0,0,0.55)] sm:-bottom-9 sm:right-2 sm:max-w-[19rem] sm:rounded-[1.35rem] lg:right-4"
                width={720}
                height={360}
                loading="lazy"
                decoding="async"
          ...
          <div className="grid gap-3 lg:col-span-2">
            <Reveal delay={80} className="card p-7">
              <h3 className="text-xl font-semibold md:text-[22px]">States instead of one-off prompts</h3>
            ...
            <Reveal delay={120} className="card p-7">
              <h3 className="text-xl font-semibold md:text-[22px]">Same account on both surfaces</h3>
              <p className="mt-3 text-base leading-relaxed text-ink/55">
